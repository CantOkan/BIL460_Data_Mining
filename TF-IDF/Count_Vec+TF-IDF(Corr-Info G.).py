# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 01:11:46 2019
...
corr_features=find_maxCorrelations(corrmat,0.9)

print(corr_features)
print("len:"+str(len(corr_features)))

#yeni correlation matrix'i
corrmat=corrmat[corr_features].loc[corr_features]

s=list(corr_features)
...
sns.pairplot(Tf_WORDS,hue="class",markers=['o','s','*','.','v','d','x'],
    vars=s)
...
#Tf_corr=Tf_WORDS.iloc[:,0:101] gives %100 acc.

from sklearn.feature_selection import mutual_info_classif,mutual_info_regression
from sklearn.feature_selection import SelectKBest

select=SelectKBest(mutual_info_classif,k=10).fit(Tf_corr,y)
X=Tf_corr.loc[:,select.get_support()]
...
print("Knn ortalama:"+str(statistics.mean(avg_knn)))
